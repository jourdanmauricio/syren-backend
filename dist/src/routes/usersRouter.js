...
usersRouter.get('/:id', passport_1.default.authenticate('jwt', { session: false }), (0, auth_1.checkRoles)(true, Credential_1.TUserRole.ADMIN, Credential_1.TUserRole.USER), (0, validatorHandler_1.default)(userSchema_1.getUserSchema, 'params'), controllers_1.getUser);
...
usersRouter.put('/change-pass/:id', passport_1.default.authenticate('jwt', { session: false }), (0, auth_1.checkRoles)(true, Credential_1.TUserRole.ADMIN, Credential_1.TUserRole.USER), (0, validatorHandler_1.default)(userSchema_1.getUserSchema, 'params'), (0, validatorHandler_1.default)(userSchema_1.changePassSchema, 'body'), controllers_1.changePass);
usersRouter.put('/:id', passport_1.default.authenticate('jwt', { session: false }), (0, auth_1.checkRoles)(true, Credential_1.TUserRole.ADMIN, Credential_1.TUserRole.USER), (0, validatorHandler_1.default)(userSchema_1.getUserSchema, 'params'), (0, validatorHandler_1.default)(userSchema_1.updateUserSchema, 'body'), controllers_1.updateUser);
